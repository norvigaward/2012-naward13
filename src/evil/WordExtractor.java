...
public class WordExtractor extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setReducerClass(LongSumReducer.class); // PairGeneratorReducer.class
		job.setCombinerClass(LongSumReducer.class); // Disabled

		// Set the name of the job.
		job.setJobName("Norvig Award - Word Extractor");
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner
				.run(new Configuration(), new WordExtractor(), args);
		System.exit(res);
	}
}