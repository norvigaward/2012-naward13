 ...
 */
public class BigramFinder extends Configured implements Tool {

	static final Logger LOG = Logger.getLogger(BigramFinder.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner
				.run(new Configuration(), new BigramFinder(), args);
		System.exit(res);
	}
}
