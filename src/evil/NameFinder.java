...
public class NameFinder extends Configured implements Tool {
	...
	static final Logger LOG = Logger.getLogger(NameFinder.class);
	...
	public int run(String[] args) throws Exception {
		...
		job.setMapperClass(NameFinderMapper.class);
		job.setReducerClass(NameFinderReducer.class);
		job.setCombinerClass(NameFinderReducer.class);

		// Set the name of the job.
		job.setJobName("Norvig Award - Evil Name Finder");
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner
				.run(new Configuration(), new NameFinder(), args);
		System.exit(res);
	}
}
